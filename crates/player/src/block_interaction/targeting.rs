...
pub(super) fn update_targeted_block(
...
pub(super) fn draw_targeted_block_highlight(
...
#[derive(Component)]
pub(super) struct TargetedBlockDebugInfo;

pub(super) fn spawn_debug_entity(mut commands: Commands) {
    commands.spawn((
...
pub(super) fn update_debug_info(
    targeted: Res<TargetedBlock>,
